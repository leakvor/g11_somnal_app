    ...
    <div class="modal" v-if="showModal" @click.self="closeModal">
      <div class="modal-content">
        ...
        <form @submit.prevent="updateProfile" method="post" enctype="multipart/form-data">
          ...
          <div class="title mt-3 mb-3">
            <input type="number" class="w-full p-2 border border-gray-300" name="phone" v-model="userData.phone" required />
          </div>
          ...
          <div class="mt-3">
            <div class="relative">
              ...
              <img v-else :src="`http://127.0.0.1:8000/uploads/${userData.profile}`" alt="Default Image" class="w-full h-300px border border-gray-300 p-2 cursor-pointer" @click="uploadImage">
              <input type="file" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" id="file_input" name="image" >
            </div>
          </div>
