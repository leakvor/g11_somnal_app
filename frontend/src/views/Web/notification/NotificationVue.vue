          ...
          <div class="box shadow-sm rounded bg-white mb-3">
            ...
            <div class="box-body p-0">
              ...
              <div class="p-3 d-flex align-items-center osahan-post-header">
                ...
                <div class="font-weight-bold mr-3">
                  <div class="mb-2">
                    We found a job at askbootstrap Ltd that you may be interested in Vivamus
                    imperdiet venenatis est...
                  </div>
            ...
            <div class="box-body p-0">
              ...
              <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                ...
                <div class="font-weight-bold mr-3">
                  ...
                  <div class="small">
                    Pellentesque semper ex diam, at tristique ipsum varius sed. Pellentesque non
                    metus ullamcorper
                  </div>
                </div>
                <span class="ml-auto mb-auto">
                ...
                <div class="font-weight-bold mr-3">
                  <div class="mb-2">
                    <span class="font-weight-normal"
                      >Congratulate Gurdeep Singh Osahan (iamgurdeeposahan)</span
                    >
              ...
              <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                ...
                <div class="font-weight-bold mr-3">
                  <div>
                    <span class="font-weight-normal"
                      >Congratulate Mnadeep singh (iamgurdeeposahan)</span
                    >
                    for 4 years at Askbootsrap Pvt.
                    <div class="small text-success">
                      <i class="fa fa-check-circle"></i> You sent Mandeep a message
                    </div>
                  </div>
                </div>
                <span class="ml-auto mb-auto">
