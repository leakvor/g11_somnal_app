    ...
    <div class="container-fluid ">
      ...
      <div class="profile-dropdown dropdown-one mb-2">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
          ...
          <li>
            <router-link to="/favorite" class="dropdown-item d-flex align-items-center ">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item me-4">
            <router-link to="/" class="nav-link" :class="{ active: isActive('/partner') }">
          ...
          <li class="nav-item d-flex align-items-center me-4">
            <router-link to="/" class="nav-link" :class="{ active: isActive('/chat') }">
          ...
          <li class="nav-item d-flex align-items-center me-4">
            <router-link to="/" class="nav-link" :class="{ active: isActive('/notifications') }">
