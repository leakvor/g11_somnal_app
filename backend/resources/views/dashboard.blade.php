            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-5">
                <a href="#" class="bg-white rounded-lg shadow-md p-4 text-center hover:-translate-y-3px hover:shadow-xl duration-300">
                    <div class="card-body">
                        ...
                        <h5 class="text-blue-500 break-all font-bold">$50363350.00</h5>
                    </div>
                </a>
                ...
                <a href="{{ route('admin.users.index')}}" class="bg-white rounded-lg shadow-md p-4 text-center hover:-translate-y-3px hover:shadow-xl duration-300">
                    <div class="card-body">
                        ...
                        <h5 class=" text-blue-500 font-bold">{{auth()->user()->count() }}</h5>
                    </div>
                </a>
                ...
                <a href="#" class="bg-white rounded-lg shadow-md p-4 text-center hover:-translate-y-3px hover:shadow-xl duration-300">
                    <div class="card-body">
                        ...
                        <h5 class="text-blue-500 font-bold">1000</h5>
                    </div>
                </a>

                <a href="#" class="bg-white rounded-lg shadow-md p-4 text-center hover:-translate-y-3px hover:shadow-xl duration-300">
                    <div class="card-body">
                        <img src="{{asset('images/icons/scrap.png')}}" alt="company" class="w-12 mx-auto mt-2">
                        <p class="mt-3 text-xs">Scrap</p>
                        <h5 class="text-blue-500 font-bold">90</h5>
                    </div>
                </a>
