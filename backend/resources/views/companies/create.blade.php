        ...
        <div class="container mx-auto mt-10 p-6 bg-white shadow-md rounded-lg">
            ...
            <form method="POST" action="{{ route('admin.companies.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="date_work" name="date_work" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
