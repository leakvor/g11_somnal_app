    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 mx-4">
        <div class="container mx-auto mt-10">
            <div class="flex flex-col sm:flex-row justify-between items-center mb-5">
                <p class="text-2xl">Companies: ({{ $companies->total() }})</p>
                
                <!-- Search Bar -->
                <div class="relative w-full sm:w-1/2 mt-4 sm:mt-0 ml-0 sm:ml-4">
                ...
                <a href="{{ route('admin.companies.create') }}" class="mt-4 sm:mt-0 ml-0 sm:ml-4 bg-green-500 text-white px-4 py-2 rounded">Add Company</a>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white">
                        ...
                        <tbody id="company-list">
                            ...
                            <tr class="border-b">
                                <td class="py-3 px-4 whitespace-nowrap">{{ $company->name }}</td>
                                <td class="py-3 px-4 whitespace-nowrap">{{ $company->phone }}</td>
                                <td class="py-3 px-4 whitespace-nowrap">{{ $company->email }}</td>
                                <td class="py-3 px-4 whitespace-nowrap">{{ $company->category->name }}</td>
                                <td class="py-3 px-4 whitespace-nowrap">{{ $company->user->name }}</td>
